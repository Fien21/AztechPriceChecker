...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Staff Login - AZTECH</title>
        ...
        <style>
            ...
            /* Staff Green Button Style */
            .btn-staff-primary { background-color: #22c55e; color: white; }
            .btn-staff-primary:hover { background-color: #16a34a; }
            ...
            <div class="w-full sm:max-w-md bg-white p-6 rounded-lg shadow-xl card-shadow-soft">
                ...
                <form method="POST" action="{{ route('teacher.login') }}" class="space-y-4">
                    ...
                    <div class="flex items-center justify-between mt-6 pt-2">
                        ...
                        {{-- Primary Button styled GREEN for Staff --}}
                        <button type="submit" class="btn-staff-primary py-2 px-4 rounded-lg font-semibold transition ms-3">
                            {{ __('Log in') }}
                        </button>
                    </div>
                </form>
