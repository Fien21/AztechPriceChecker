...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Customer Login - AZTECH</title>
        ...
        <style>
            ...
            /* Customer Blue Button Style */
            .btn-customer-primary { background-color: #3b82f6; color: white; }
            .btn-customer-primary:hover { background-color: #2563eb; }
            ...
            <div class="w-full sm:max-w-md bg-white p-6 rounded-lg shadow-xl card-shadow-soft">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-4">
                    ...
                    <div class="flex items-center justify-between mt-6 pt-2">
                        ...
                        {{-- Primary Button styled BLUE for Customer --}}
                        <button type="submit" class="btn-customer-primary py-2 px-4 rounded-lg font-semibold transition ms-3">
                            {{ __('Log in') }}
                        </button>
                    </div>
                </form>
