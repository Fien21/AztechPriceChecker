<x-admin-app-layout>
    ...
    <div class="py-12 bg-[#0B3D91] min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <!-- Daily Price Scans (Guest Activity) -->
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <!-- Chart Area: Price Checking Trends -->
                <div class="lg:col-span-2 bg-white p-6 rounded-xl shadow-xl border-t-4 border-red-600">
                ...
                <div class="bg-white p-6 rounded-xl shadow-xl border-t-4 border-red-600">
                    ...
                    <div class="space-y-3">
                        <!-- Product Management -->
                        <button onclick="navigateAction('Inventory', 'Opening Product Price Master...')" class="w-full text-left p-3 rounded-lg bg-gray-50 hover:bg-red-50 border border-gray-200 transition group flex items-center">
                            <span class="mr-3">📦</span>
                            <span class="font-semibold text-gray-700 group-hover:text-red-700">Update Product Prices</span>
                        </button>

                        <!-- Barcode Generator -->
                        <button onclick="navigateAction('Barcodes', 'Accessing Barcode Generator...')" class="w-full text-left p-3 rounded-lg bg-gray-50 hover:bg-red-50 border border-gray-200 transition group flex items-center">
                            <span class="mr-3">🏷️</span>
                            <span class="font-semibold text-gray-700 group-hover:text-red-700">Generate Barcode Labels</span>
                        </button>

                        <!-- Staff Management -->
                        <button onclick="navigateAction('Staff', 'Loading Staff Directory...')" class="w-full text-left p-3 rounded-lg bg-gray-50 hover:bg-red-50 border border-gray-200 transition group flex items-center">
                            <span class="mr-3">👷</span>
                            <span class="font-semibold text-gray-700 group-hover:text-red-700">Manage Staff Accounts</span>
                        </button>

                        <!-- Activity Logs -->
                        <button onclick="navigateAction('Logs', 'Fetching system logs...')" class="w-full text-left p-3 rounded-lg bg-gray-50 hover:bg-red-50 border border-gray-200 transition group flex items-center">
                            <span class="mr-3">📋</span>
    ...
    <!-- Dashboard Scripts -->
    <script>
        // 1. Chart.js: Displaying Price Check Trends
        ...
        // 2. SweetAlert2: Interface Feedback
        ...
        document.getElementById('syncBtn').addEventListener('click', function() {
            Swal.fire({
                ...
                text: "This will push current Admin pricing to all guest scanner terminals.",
                icon: 'question',
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: 'Syncing Data...',
                        html: 'Updating terminals in <b></b> milliseconds.',
                        timer: 2000,
                        ...
                        Swal.fire({
                            title: 'Success!',
                            text: 'All branches and terminals updated.',
                            icon: 'success',
                            confirmButtonColor: '#ef4444'
                        });
                    });
        ...
        // Auto-show welcome alert if success session exists
        @if(session('success'))
            Swal.fire({
                title: 'Welcome, Admin',
